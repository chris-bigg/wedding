import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as t}from"./index.Cd_vQiNd.js";import{O as g}from"./index.WiVy9duh.js";function x(){const[a,s]=t.useState(!0),[i,r]=t.useState(!1),[n,o]=t.useState(!1),[l,m]=t.useState(!1);return t.useEffect(()=>{const d=setTimeout(()=>{o(!0),m(!0)},3e3),c=setTimeout(()=>{r(!0)},5300),u=setTimeout(()=>{s(!1),window.dispatchEvent(new CustomEvent("splashComplete")),sessionStorage.setItem("splashCompleted","true")},6300);return()=>{clearTimeout(d),clearTimeout(c),clearTimeout(u)}},[]),a?e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
